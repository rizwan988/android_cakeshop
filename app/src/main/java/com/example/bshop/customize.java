...
public class customize extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flowerPrices.put(R.drawable.strawberrycakeround, 10);
        flowerPrices.put(R.drawable.chocolatecakeround, 15);
        flowerPrices.put(R.drawable.pineapplecakeround, 10);
        ...
        findViewById(R.id.strawberrycakeround).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                addFlowerToPreview(R.drawable.strawberrycakeround);
            }
        });

        findViewById(R.id.chocolatecakeround).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                addFlowerToPreview(R.drawable.chocolatecakeround);
            }
        });

        findViewById(R.id.pineapplecakeround).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                addFlowerToPreview(R.drawable.pineapplecakeround);
            }
        });
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addressIntent = new Intent(customize.this, Address.class);
    ...
    private String getFlowerName(int flowerResourceId) {
        if (flowerResourceId == R.drawable.strawberrycakeround) {
            return "Red Rose";
        } else if (flowerResourceId == R.drawable.chocolatecakeround) {
            return "White Rose";
        } else if (flowerResourceId == R.drawable.pineapplecakeround) {
            return "Pink Rose";
        } else {
    ...
    private void addFlowerToPreview(int flowerResourceId) {
        ...
        int top = dpToPx(30) + random.nextInt(dpToPx(90) - dpToPx(30) + 1);
        int left = dpToPx(40) + random.nextInt(dpToPx(130) - dpToPx(40) + 1);
        ...
        if (selectedFlowers.containsKey(flowerResourceId)) {
            int quantity = selectedFlowers.get(flowerResourceId) + 1;
            selectedFlowers.put(flowerResourceId, quantity);
        } else {
            selectedFlowers.put(flowerResourceId, 1);
        }
            ...
            public void onClick(View view) {
                ...
                if (selectedFlowers.containsKey(flowerResourceId)) {
                    ...
                    if (quantity > 0) {
                        ...
                        selectedFlowers.remove(flowerResourceId);
                    }
                }
            }
        });
