...
public class customize3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flowerPrices.put(R.drawable.strawberrysquarecake, 10);
        flowerPrices.put(R.drawable.redvelvetsquarecake, 15);
        flowerPrices.put(R.drawable.chocolatesquarecake, 10);
        ...
        findViewById(R.id.strawberrysquarecake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                updateImagePreview(R.drawable.strawberrysquarecake);
            }
        });

        findViewById(R.id.redvelvetsquarecake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                updateImagePreview(R.drawable.redvelvetsquarecake);
            }
        });

        findViewById(R.id.chocolatesquarecake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                updateImagePreview(R.drawable.chocolatesquarecake);
            }
        });
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addressIntent = new Intent(customize3.this, Address.class);
    ...
    private String getFlowerName(int flowerResourceId) {
        if (flowerResourceId == R.drawable.strawberrysquarecake) {
            return "strawberrysquarecake";
        } else if (flowerResourceId == R.drawable.redvelvetsquarecake) {
            return "redvelvetsquarecake";
        } else if (flowerResourceId == R.drawable.chocolatesquarecake) {
            return "chocolatesquarecake";
        } else {
