...
public class customize4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flowerPrices.put(R.drawable.strawberrystepcake, 10);
        flowerPrices.put(R.drawable.chocolatestepcake, 15);
        flowerPrices.put(R.drawable.lovestepcake, 10);
        ...
        findViewById(R.id.strawberrystepcake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                updateImagePreview(R.drawable.strawberrystepcake);
            }
        });

        findViewById(R.id.chocolatestepcake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                updateImagePreview(R.drawable.chocolatestepcake);
            }
        });

        findViewById(R.id.lovestepcake).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                // Add logic to update image_preview with the selected flower image
                updateImagePreview(R.drawable.lovestepcake);
            }
        });
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addressIntent = new Intent(customize4.this, Address.class);
    ...
    private String getFlowerName(int flowerResourceId) {
        if (flowerResourceId == R.drawable.strawberrystepcake) {
            return "strawberrystepcake";
        } else if (flowerResourceId == R.drawable.chocolatestepcake) {
            return "chocolatestepcake";
        } else if (flowerResourceId == R.drawable.lovestepcake) {
            return "lovestepcake";
        } else {
